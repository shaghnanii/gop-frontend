    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
          ...
          <span class="text-[#0b2545]">Create Notice</span></div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2">
          <div class="bg-white border border-gray-200 rounded-lg p-6">
            <div class="space-y-6"><h2 class="text-[#0b2545] mb-4">Metadata</h2>
              <div><label class="block text-sm text-gray-700 mb-2">Title <span
            ...
            <div class="flex justify-between mt-8 pt-6 border-t border-gray-200">
              <button class="px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50" disabled="">Previous</button>
